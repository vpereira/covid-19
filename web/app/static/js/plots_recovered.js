function showMainChart(country) {
    $.ajax({
        url: '/plot/country/recovered/' + country,
        type: "GET",
...
function refreshExponentialGrowthTable(country) {
    $('#exponential').bootstrapTable('refresh', {url: '/exponential/country/recovered/' + country});
}

function updateTable(country) {
    $.ajax({
        url: '/information/country/recovered/' + country,
        type: "GET",
        contentType: 'application/json;charset=UTF-8',
        dataType:"json",
        success: function (data) {
...
$(document).ready(function() {
    ...
    $('.dropdown-item').click(function(e){
        ...
        //$('#country-title').text('Dashboard for ' + country);
